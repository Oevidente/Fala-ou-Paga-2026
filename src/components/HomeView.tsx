    ...
    >
      ...
      <div className="flex justify-between items-center mb-10 md:mb-24 relative mt-4 md:mt-8">
        <div className="z-10 w-[140px] md:w-[280px] flex flex-col items-start">
          <img
            src={`${import.meta.env.BASE_URL}pngs/Logo.png`}
            alt="Fala ou Paga"
      ...
      <div className="mb-8 md:mb-16 relative z-10">
        <h2 className="text-xl md:text-4xl font-bold text-white mb-4 md:mb-8 italic tracking-tight text-glow">
          Tipos de Cartas
        </h2>
        <div className="grid grid-cols-4 gap-2 sm:gap-4 md:gap-8">
          ...
          <div className="flex flex-col gap-2 md:gap-0">
            <div className="group aspect-square md:aspect-[4/3] rounded-2xl sm:rounded-3xl md:rounded-[2rem] bg-gradient-to-br from-white/80 to-white/40 hover:from-[#4a72ba] hover:to-[#223963] backdrop-blur border border-white/50 flex items-center justify-center shadow-lg p-2 md:p-6 overflow-hidden relative transition-all duration-300 cursor-pointer">
              <img
                src={`${import.meta.env.BASE_URL}pngs/interrogação.png`}
                alt="Livre"
                className="w-full h-full object-contain opacity-40 mix-blend-multiply transition-all duration-300 group-hover:opacity-10 group-hover:mix-blend-normal group-hover:scale-110"
              />
              <div className="absolute inset-0 md:flex flex-col items-center justify-center p-2 md:p-6 hidden group-hover:flex opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 text-center bg-gradient-to-t from-black/50 to-transparent">
                <h3 className="text-white font-bold text-[13px] sm:text-[15px] md:text-2xl mb-1 md:mb-3 leading-tight drop-shadow-md">
                  Carta Prata
                </h3>
                <p className="text-white text-[10px] sm:text-[11px] md:text-base leading-[1.1] sm:leading-tight drop-shadow">
                  Essa carta permite que se faça a pergunta que desejar.
                </p>
              </div>
            </div>
            {/* Mobile-only description */}
            <div className="md:hidden text-center p-2 rounded-lg bg-black/20 backdrop-blur-sm">
              <h3 className="text-white font-bold text-[12px] sm:text-[13px] leading-tight mb-0.5 drop-shadow">
                Carta Prata
              </h3>
              <p className="text-white/80 text-[10px] sm:text-[11px] leading-snug drop-shadow-sm">
                Essa carta permite que se faça a pergunta que desejar.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2 md:gap-0">
            <div className="group aspect-square md:aspect-[4/3] rounded-2xl sm:rounded-3xl md:rounded-[2rem] bg-gradient-to-br from-pink-400 to-pink-500 hover:from-[#2a2640] hover:to-[#151221] backdrop-blur border border-pink-300/50 flex items-center justify-center shadow-lg p-2 md:p-6 overflow-hidden relative transition-all duration-300 cursor-pointer">
              <img
                src={`${import.meta.env.BASE_URL}pngs/interrogação.png`}
                alt="Fala ou Paga"
                className="w-full h-full object-contain opacity-90 drop-shadow-md transition-all duration-300 group-hover:opacity-10 group-hover:scale-110"
              />
              <div className="absolute inset-0 md:flex flex-col items-center justify-center p-2 md:p-6 hidden group-hover:flex opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 text-center bg-gradient-to-t from-black/50 to-transparent">
                <h3 className="text-white font-bold text-[13px] sm:text-[15px] md:text-2xl mb-1 md:mb-3 leading-tight drop-shadow-md">
                  Carta Rosa
                ...
                <p className="text-white text-[10px] sm:text-[11px] md:text-base leading-[1.1] sm:leading-tight drop-shadow">
                  Essa carta contém uma pergunta escrita de qualquer tipo.
                </p>
              </div>
            </div>
            {/* Mobile-only description */}
          ...
          {/* Carta Azul */}
          <div className="flex flex-col gap-2 md:gap-0">
            <div className="group aspect-square md:aspect-[4/3] rounded-2xl sm:rounded-3xl md:rounded-[2rem] bg-gradient-to-br from-blue-400 to-blue-600 hover:from-[#1c2b4d] hover:to-[#11192e] backdrop-blur border border-blue-300/50 flex items-center justify-center shadow-lg p-2 md:p-6 overflow-hidden relative transition-all duration-300 cursor-pointer">
              <img
                src={`${import.meta.env.BASE_URL}pngs/interrogação.png`}
                alt="Pergunta em Dupla"
                className="w-full h-full object-contain opacity-90 drop-shadow-md transition-all duration-300 group-hover:opacity-10 group-hover:scale-110"
              />
              <div className="absolute inset-0 md:flex flex-col items-center justify-center p-2 md:p-6 hidden group-hover:flex opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 text-center bg-gradient-to-t from-black/50 to-transparent">
                <h3 className="text-white font-bold text-[13px] sm:text-[15px] md:text-2xl mb-1 md:mb-3 leading-tight drop-shadow-md">
                ...
                <p className="text-white text-[10px] sm:text-[11px] md:text-base leading-[1.1] sm:leading-tight drop-shadow">
                  Pergunta para ser respondida em dupla, ao mesmo tempo.
                </p>
              </div>
            </div>
            {/* Mobile-only description */}
          ...
          <div className="flex flex-col gap-2 md:gap-0">
            <div className="group aspect-square md:aspect-[4/3] rounded-2xl sm:rounded-3xl md:rounded-[2rem] bg-gradient-to-br from-orange-400 to-yellow-500 hover:from-[#1b301f] hover:to-[#0f1d12] backdrop-blur border border-yellow-300/50 flex items-center justify-center shadow-lg p-2 md:p-6 overflow-hidden relative transition-all duration-300 cursor-pointer">
              <img
                src={`${import.meta.env.BASE_URL}pngs/18 simbolo.png`}
                alt="Desafio"
                className="w-full h-full object-contain drop-shadow-md opacity-90 transition-all duration-300 group-hover:opacity-10 group-hover:scale-110"
              />
              <div className="absolute inset-0 md:flex flex-col items-center justify-center p-2 md:p-6 hidden group-hover:flex opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 text-center bg-gradient-to-t from-black/50 to-transparent">
                <h3 className="text-white font-bold text-[13px] sm:text-[15px] md:text-2xl mb-1 md:mb-3 leading-tight drop-shadow-md">
                  Carta Desafio
                ...
                <p className="text-white text-[10px] sm:text-[11px] md:text-base leading-[1.1] sm:leading-tight drop-shadow">
                  Essa carta traz uma punição/desafio para quem se recusar a
                  perguntar ou responder uma pergunta.
                </p>
              </div>
            </div>
            {/* Mobile-only description */}
      ...
      <div className="mb-8 md:mb-16">
        ...
        <div className="p-5 md:p-10 rounded-[1.5rem] md:rounded-[2rem] backdrop-blur-xl border border-white/20 shadow-xl bg-white/10">
          <p className="text-white text-[15px] md:text-2xl leading-relaxed md:leading-relaxed">
            Criar um ambiente divertido e desinibido, em que os participantes se
            desafiem a responder perguntas ou cumpram punições criativas.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="p-5 md:p-8 rounded-[1.5rem] md:rounded-[2rem] backdrop-blur-xl border border-white/20 shadow-xl bg-white/10">
          <div className="max-h-[300px] md:max-h-[400px] overflow-y-auto pr-4 space-y-6 text-white/90 text-[15px] md:text-lg leading-relaxed md:leading-relaxed">
            <section>
              <h3 className="text-lg font-bold text-white mb-2 text-glow">
                1. Objetivo:
              </h3>
              <p>
                Criar um ambiente divertido e desinibido, em que os
                participantes se desafiem a responder perguntas ou cumpram
                punições criativas.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-1 list-disc list-inside">
                ...
                <li>
                  Se for vermelha, lê em voz alta a pergunta e faz ao outro
                  participante.
                </li>
                <li>
                  Se for prateada, o jogador escolhe qualquer pergunta que
                  quiser (pergunta livre).
                </li>
            ...
            <section>
              ...
              <ul className="space-y-1 list-disc list-inside">
                <li>
                  Se o questionado se recusar a responder, o questionador deve
                  puxar uma carta dourada e cumprir o desafio indicado.
                </li>
                <li>
                  Se quem puxou a carta (a vez) se sentir tímido ou não quiser
                  fazer a pergunta, o outro jogador puxa uma carta dourada e
                  realiza o desafio.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-1 list-disc list-inside">
                <li>
                  Independente de quem puxar a carta, os dois participantes
                  devem responder ao mesmo tempo.
                </li>
                <li>
                  Se apenas uma pessoa se recusar a responder, a punição vale
                  para os dois. Uma carta dourada deve ser puxada e{" "}
                  <strong>ambos</strong> devem pagar o desafio.
                </li>
              </ul>
            </section>
            ...
            <section>
              <h3 className="text-lg font-bold text-white mb-2 text-glow">
                7. Cartas de Desafio (Douradas):
              </h3>
              <p>Cada carta dourada traz uma punição criativa.</p>
            </section>
          </div>
